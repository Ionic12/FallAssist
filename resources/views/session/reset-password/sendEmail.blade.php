                    ...
                    <div class="card-body">
                        <form action="/forgot-password" method="POST" role="form text-left">
                            ...
                            <div class="text-center d-flex justify-content-between mt-3">
                                <button type="submit" id="button" class="btn w-75">Recover your password</button>
                                <button type="button" class="btn bg-gradient-dark" onclick="window.history.back();">{{ 'Back' }}</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<style>
    .text-center {
        ...
        justify-content: space-between; /* Distribute buttons evenly (optional) */
    }
    #button{
