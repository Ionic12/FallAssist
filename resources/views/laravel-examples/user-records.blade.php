    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body pt-4 p-3">
                <form action="{{ route('records.store') }}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="form-group">
                        ...
                        <div class="@error('user.records')border border-danger rounded-3 @enderror">
                            <textarea maxlength="650" class="form-control" id="records" rows="5" placeholder="Enter your elderly health notes." name="records" oninput="countLetters()"></textarea>
