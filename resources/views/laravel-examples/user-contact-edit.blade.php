   ...
   <div class="container-fluid">
      <div class="card">
         <div class="card-body pt-4 p-3">
            <form action="{{ route('contact.update') }}" method="POST" role="form text-left">
               @method('PUT')
               @csrf
               @if($errors->any())
                     ...
                     <div class="form-group">
                        ...
                        <div class="@error('name')border border-danger rounded-3 @enderror">
                           <input class="form-control" type="text" placeholder="Name" id="name" name="name"
                              ...
                              oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '')" value="{{ $contact->name }}">
                           @error('name')
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="@error('phone')border border-danger rounded-3 @enderror">
                           <input class="form-control" value="{{ $contact->phone }}" maxlength="13" type="number" placeholder="Phone Number" id="phone" name="phone" pattern="^[0-9]*$">
                           @error('phone')
                           <p class="text-danger text-xs mt-2">{{ $message }}</p>
                           @enderror
                        </div>
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="@error('username')border border-danger rounded-3 @enderror">
                           <input class="form-control" value="{{ $contact->username }}" type="text"  placeholder="Username Telegram" id="username" name="username">
                           @error('name')
                           <p class="text-danger text-xs mt-2">{{ $message }}</p>
                           @enderror
                        </div>
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="@error('idchat')border border-danger rounded-3 @enderror">
                           <input class="form-control" value="{{ $contact->idchat }}" type="text" maxlength="15" placeholder="ID Chat Telegram" id="idchat" name="idchat">
                           @error('idchat')
                           <p class="text-danger text-xs mt-2">{{ $message }}</p>
                           @enderror
                        </div>
